...
public class CompanionAppIntentHandlerTest {
    @Rule
    ...
    @Before
    public void init() {
        handler = new CompanionAppIntentHandler();
    }
    ...
    public void doesHandle() {
        ...
        assertNotNull(canHandle.get().getCard());
        assertNotNull(canHandle.get().getOutputSpeech());
    }
}
